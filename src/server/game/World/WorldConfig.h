...
enum ServerConfigs
{
    ...
    CONFIG_MILL_PROSPECT_WHOLE_STACK,
    CONFIG_LOOT_UNCAP_CHANCE,
    CONFIG_LOOT_CONSOLIDATE_STACKS,
    CONFIG_LOOT_RARITY_PRIORITY_CAP,
    ...
    CONFIG_QUEST_DAILY_RESETS_PER_CALENDAR_DAY,
