...
void WorldConfig::BuildConfigCache()
{
    ...
    SetConfigValue<bool>(CONFIG_LOOT_UNCAP_CHANCE, "Rate.Drop.Item.UncapChance", true);
    SetConfigValue<bool>(CONFIG_LOOT_CONSOLIDATE_STACKS, "Loot.ConsolidateStacks", true);
    SetConfigValue<bool>(CONFIG_LOOT_RARITY_PRIORITY_CAP, "Loot.RarityPriorityCap", true);
